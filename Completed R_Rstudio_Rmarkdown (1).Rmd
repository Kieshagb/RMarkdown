...
## Introduction to Health Data Science Learning Outcomes
1. Communicate information from health data in written form
1. Explain how data science is used to address healthcare problems
1. Analyse current challenges in health data science
1. Apply the data science workflow using R to healthcare problems
1. Discuss the limitations and assumptions made in health data science projects 
